<?php
// source: E:\xampp\htdocs\www\unt_cz_nette\app\presenters/templates/@layout.latte

class Templated17382d26a1f82b229d0dcd9a211f08f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('341e0fc056', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb7e5e299b3e_head')) { function _lb7e5e299b3e_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb5d886da3c_scripts')) { function _lbb5d886da3c_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
