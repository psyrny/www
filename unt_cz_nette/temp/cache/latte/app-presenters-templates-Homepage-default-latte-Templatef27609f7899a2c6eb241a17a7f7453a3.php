<?php
// source: E:\xampp\htdocs\www\unt_cz_nette\app\presenters/templates/Homepage/default.latte

class Templatef27609f7899a2c6eb241a17a7f7453a3 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('367a814b1b', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb9ed9afcdbc_content')) { function _lb9ed9afcdbc_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb48b3c79efc_title')) { function _lb48b3c79efc_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb2a94c29dd8_scripts')) { function _lb2a94c29dd8_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbba34658158_head')) { function _lbba34658158_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
